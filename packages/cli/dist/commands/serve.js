    ...
    return __awaiter(void 0, __spreadArray([], args_1, true), void 0, function (filename, options) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    dir = path_1.default.join(process.cwd(), path_1.default.dirname(filename), path_1.default.basename(filename));
                    return [4 /*yield*/, (0, local_api_1.serve)(parseInt(options.port), path_1.default.basename(filename), dir, !isProduction)];
                case 2:
                    _a.sent();
                    console.log("\n                'Opened ".concat(filename, ". Navigate to http://localhost:").concat(options.port, " to edit the file.'\n                "));
                    return [3 /*break*/, 4];
                case 3:
                    err_1 = _a.sent();
